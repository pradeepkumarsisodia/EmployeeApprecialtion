...
namespace Appreciation.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            Model.LoginModel objloginModel = new Model.LoginModel();
            objloginModel.Email = model.Email;
            objloginModel.Password = model.Password;

            Int32 loginUserId = BAL.Login.loginUser(objloginModel);
            if (loginUserId > 0)
            {
